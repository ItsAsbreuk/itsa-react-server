...
},
{
    ...
    _createBodyElement: function(props) {
        ...
        if (viewContainer) {
            newProps = itsaReactCloneProps.clone(props);
            newProps.ref = inst => instance._currentComponent=inst;
            NewComponent = React.createElement(
                BaseComponent,
                newProps
            );
            ReactDOM.render(NewComponent, viewContainer);
        }
        else {
